...
export type AuthAdminOptionalAttributes =
  | "id"
  | "password"
  | "createdAt"
  | "updatedAt";
export type AuthAdminCreationAttributes = Optional<
  AuthAdminAttributes,
  AuthAdminOptionalAttributes
>;

export class AuthAdmin
  extends Model<AuthAdminAttributes, AuthAdminCreationAttributes>
  implements AuthAdminAttributes
{
  id!: number;
  email!: string;
  password?: string;
